package com.vecher.gathering.service;
...
import com.vecher.gathering.pojo.Gathering;
...
import com.vecher.gathering.dao.GatheringDao;
...
public class GatheringService {
	 ...
	 * @return
	 */
	// value 是全局缓存名称 没啥用 key才是缓存的具体要根据这个key去找的数据key # 拿到当前的id
	// 加上之后优先去缓存中去找
